...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Chaos Coin Core chaoscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  chaoscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chaos coin transaction") + "\n" +
                               "  chaoscoin-tx [options] -create [commands]   " + _("Create hex-encoded chaos coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chaos coin transaction
