...
/** Utility functions used by the ChaosCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render HAO addresses in monospace font
...
// Parse "chaoscoin:" URI into recipient object, return true on successful parsing
