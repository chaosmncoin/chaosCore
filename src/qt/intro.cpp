...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Chaos Coin Core"),
     ...
     * override -datadir in the chaoscoin.conf file in the default data directory
     * (to be consistent with chaoscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
