...
/* Chaos Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ChaosCoin"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "ChaosCoin-Qt"
#define QAPP_APP_NAME_TESTNET "ChaosCoin-Qt-testnet"
