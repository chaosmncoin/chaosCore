...
#if defined(NDEBUG)
#error "Zio Coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uzio) are considered zero fee (for relaying and mining)
