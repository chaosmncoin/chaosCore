...
In order to support loading of multiple wallets in chaoscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is chaoscoin.cpp.
...
Changes to chaoscoin.cpp
----------------------
chaoscoin.cpp is the entry point into chaoscoin-qt, and as such, will require some minor modifications to provide hooks for
