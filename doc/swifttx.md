...
This mechanism has been integrated into Bitcore-Node-ChaosCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/chaoscoin/insight-api-chaoscoin#web-socket-api](https://github.com/chaoscoin/insight-api-chaoscoin#web-socket-api)
* API: [https://github.com/chaoscoin/insight-api-chaoscoin#swifttx-transactions](https://github.com/chaoscoin/insight-api-chaoscoin#swifttx-transactions)
...
By default, the Chaos Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Chaos Coin Core daemon:
