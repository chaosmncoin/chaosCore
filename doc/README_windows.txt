...
Intro
-----
Chaos Coin (HAO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Chaos Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run chaoscoin-qt.exe.

Chaos Coin Core is the original Chaos Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Chaos Coin transactions;
