Contributing to Chaos Coin Core
==================================

The Chaos Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Chaos Coin Core project, and is not to be
confused with overall Chaos Coin Network Protocol consensus changes.

Whether a pull request is merged into Chaos Coin Core rests with the project merge
...
Patches that change Chaos Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Chaos Coin consensus, it must have been
...
The project leader is the release manager for each Chaos Coin Core release.
